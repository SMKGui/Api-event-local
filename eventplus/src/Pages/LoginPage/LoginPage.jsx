  ...
  async function handleSubmit(e) {
    ...
    if (user.email.length > 3 && user.senha.length >= 3) {
      ...
      try {
        ...
        navigate("/");//manda o usuario para a home
      } catch (error) {
        alert(
          "Usuário ou senha inválidos ou conexão com internet interrompida"
        );
      }
    } else {
    ...
    <div className="layout-grid-login">
      <div className="login">
        ...
        <div className="frm-login">
          ...
          <form onSubmit={handleSubmit} className="frm-login__formbox">
            <Input
